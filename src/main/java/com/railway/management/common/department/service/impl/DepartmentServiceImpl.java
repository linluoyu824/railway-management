package com.railway.management.common.department.service.impl;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Override
    @Transactional
    public ExcelImportResult<DepartmentImportDto> importDepartments(InputStream inputStream) {
        ExcelImportResult<DepartmentImportDto> result = new ExcelImportResult<>();
