package com.railway.management.common.user.service.impl;
...
import com.railway.management.common.permission.position.mapper.PositionMapper;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public ExcelImportResult<UserImportDto> importUsersFromExcel(InputStream inputStream) {
        ExcelImportResult<UserImportDto> result = new ExcelImportResult<>();
